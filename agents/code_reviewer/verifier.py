...
from agents.code_reviewer.models import Gate, GateResult, Patch, Verification
from agents.code_reviewer.safety import check_patch, normalise
...
def check_scope(patch: Patch) -> GateResult:
    ...
    "is this file off limits to the code reviewer at all"; scope asks "did this
...
def check_regression_test(patch: Patch) -> GateResult:
    ...
    The code reviewer cannot write into `tests/`, so it cannot add the test itself.
