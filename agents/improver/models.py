...
boolean, and `ImprovementRun` keeps what was attempted and failed alongside
what succeeded.
"""
...
class FileEntry(BaseModel):
    ...
    is_self: bool = Field(default=False, description="Part of the improver itself.")
    protected: bool = Field(default=False, description="A file the improver may never modify.")
