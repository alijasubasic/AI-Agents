...
adapts every outcome into a `Decision`, and hands the lot to the brain.
...
from agents.brain.collect import (
...
from agents.brain.models import Decision
from agents.brain.scripted import FOLLOW_UP_DRAFTS, OUTREACH_DRAFTS
