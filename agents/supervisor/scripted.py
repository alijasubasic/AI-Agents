"""Scripted drafts and judgements for the supervisor demo and tests.
...
from agents.supervisor.models import Decision, Judgement, Verdict
...
def judge_provider(decisions: list[Decision], *, model: str = "claude-opus-5") -> MockProvider:
    """Build a provider scripted for exactly the decisions the supervisor will judge.
