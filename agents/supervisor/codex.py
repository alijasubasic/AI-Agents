...
from agents.supervisor.models import CodexFinding, Decision, Severity, Verdict
...
def article_1_human_authority(decision: Decision) -> list[CodexFinding]:
    """A specialist agent's escalation is final. The supervisor may not overturn it.
