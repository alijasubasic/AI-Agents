...
The supervisor reviews decisions the specialist agents have already made. It combines
...
class SupervisorAgent:
    ...
    def _judge(self, decision: Decision, findings, verdict: Verdict) -> Judgement | None:
        ...
        Skipped in two cases. Without a provider the supervisor runs on the codex
